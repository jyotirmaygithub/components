...
const EarningsBox = () => {
  return (
    <div className='p-4 bg-white shadow-md rounded-md space-y-2 m-4'>
      <div className='flex items-center'>
        <div className='border-l-4 rounded-lg border-blue-300 h-8'></div>
        <h1 className='text-xl font-bold pl-4'>Earnings</h1>
      </div>
      <div className='flex flex-col sm:flex-row text-center justify-center space-y-4 sm:space-y-0 sm:space-x-28 border-t border-gray-200 pt-4'>
