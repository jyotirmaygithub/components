...
const AdminPage = () => {
  const user = {
    profileImage:
      'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?crop=entropy&cs=srgb&fm=jpg&ixid=M3w1MTIzNDJ8MHwxfGFsbHx8fHx8fHx8fDE3MTk0ODc4OTV8&ixlib=rb-4.0.3&q=85',
    name: 'Json Taylor',
